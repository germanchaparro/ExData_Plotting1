...
# plot 3rd graph in position (1, 2)
plot( dmy_hms ( paste ( householdPC_DF$Date, householdPC_DF$Time, sep = " " ) ), 
      householdPC_DF$Voltage, type = "n", xlab = "datetime", ylab = "Voltage")
lines( dmy_hms(paste(householdPC_DF$Date, householdPC_DF$Time, sep = " ") ), 
       householdPC_DF$Voltage)

# plot 3th graph in position (2, 2)
plot( dmy_hms ( paste ( householdPC_DF$Date, householdPC_DF$Time, sep = " " ) ), 
      householdPC_DF$Global_reactive_power, type = "n", xlab = "datetime", ylab = "Global_reactive_power")
lines( dmy_hms(paste(householdPC_DF$Date, householdPC_DF$Time, sep = " ") ), 
       householdPC_DF$Global_reactive_power)
